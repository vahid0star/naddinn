<template>
  ...
  <div class="container flex-col items-center text-center justify-center" style="max-width: 600px;">
    ...
    <div class=" flex flex-row justify-content-center mt-5">
      ...
      <a-button class=" bg-blue-500" type="primary" @click="submitTask">{{$store.state.button}}</a-button>
    </div>
    <table class="table table-bordered">
      ...
      <td class=" text-center ">
        <div @click="editTask(index)">
          <p class="fas fa-pen cursor-pointer pointer"></p>
        </div>
      </td>
      <td class=" text-center ">
        <div @click="deleteTask(index)">
          <span class="fas fa-trash cursor-pointer pointer"></span>
        </div>
      </td>
    </tr>
  </tbody>
